...
namespace YaleApplianceUITests.Pages
{
    public class PaymentPage
    {
        ...
        private const string _firstNameJsClick  = "document.querySelector(\"#CheckoutViewModel_BillingAddress_FirstName\").click()";
        ...
        public PaymentPage EnterBillingAddress()
        {
            ...
            _wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(_firstName));
            _webActions.MoveTo(_webDriverContext.Driver, ZipCode, State);
            _webActions.MoveToAndHold(_webDriverContext.Driver, State);
            select.SelectByText("Rhode Island");
            ((IJavaScriptExecutor) _webDriverContext.Driver).ExecuteScript(_firstNameJsClick);
            _webActions.MoveTo(_webDriverContext.Driver,State,FirstName);
            FirstName.Click();
            _wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementIsVisible(_state));
            _wait.Until(SeleniumExtras.WaitHelpers.ExpectedConditions.ElementToBeClickable(_state));
