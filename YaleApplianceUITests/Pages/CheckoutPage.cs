...
namespace YaleApplianceUITests.Pages
{
    public class CheckoutPage
    {
        ...
        private const string ChooseProfessionalDeliveryJs = "document.querySelector(\"#delivery-methods > div > label:nth-child(3) > div > div.deliveryItem_header > div > input[type=radio]\").click()";
        private readonly By _ChooseProfessionDelveryBtn = By.CssSelector("delivery-methods > div > label:nth-child(3) > div > div.deliveryItem_header > div > input[type=radio");
        ...
        public CheckoutPage ChooseProfessionalDeliveryOption()
                {
                    ...
                    try
                    {
                        ...
                        _webDriverContext.Driver.ExecuteJavaScript(ChooseProfessionalDeliveryJs);
